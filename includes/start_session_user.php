<?php
 ...
 $res=mysqli_query($con, "SELECT first_name, family_name, date_of_birth, users.id AS user_id, avatars.location AS avatar, avatars.id AS avatar_id, email, fk_classes FROM users 
